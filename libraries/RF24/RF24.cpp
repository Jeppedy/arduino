...
//    Serial.print("Status and flags: "); Serial.println( status & ( _BV(TX_DS) | _BV(MAX_RT) ) ) ;
//    Serial.print("Status and TX_DS: "); Serial.println( status & _BV(TX_DS) ) ;
//    Serial.print("Status and MAX_RT: "); Serial.println( status & _BV(MAX_RT) ) ;
//    Serial.print("chk timeout: "); Serial.println( ( micros() - sent_at < timeout ) ) ;
  }
...
//Serial.print("payload_avail:") ; Serial.println(ack_payload_available) ;
